        ...
        <div className="space-y-1.5">
            ...
            <div className="relative">
                <input
                    ...
                    placeholder="—"
                    className="w-full h-10 pl-3 pr-10 text-sm font-medium bg-surface-50 border border-surface-200 rounded-xl outline-none transition-colors text-foreground placeholder:text-surface-400 focus:bg-primary-50 focus:border-primary-500"
                />
                ...
                <div className="flex-1 overflow-y-auto px-5 pb-5 pt-1 space-y-5">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <input
                            ...
                            disabled={isEdit}
                            className="flex h-11 w-full rounded-xl border border-surface-200 px-4 text-sm text-foreground bg-surface-50 outline-none focus:bg-primary-50 focus:border-primary-500 disabled:opacity-60"
                        />
                    </div>
